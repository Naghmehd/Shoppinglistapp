...
/*Giving the user the instructions for this app*/
	$('#outer-area').prepend('<p class="dashed"> Enter each time in the text box below then press enter </p>');
	$('#outer-area').prepend('<p class="dashed"> Time to make that grocery list! </p>');
/*Allows an "Enter" keystroke to work as a submit button for input fields*/
	function getItem() {
...
/*Takes returned value from previous function and manipulates it */
	function postItem () {
		...
		var work = '<p class="full-width">'+ xMark + item + checkMark + '</p>';
